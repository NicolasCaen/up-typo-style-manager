            ...
            <div style="display: flex; gap: 10px; align-items: end; margin-bottom: 10px;">
                <div>
                    ...
                    <select name="block_type" id="block_type" style="min-width: 200px;">
                        ...
                        <option value="core/button">core/button</option>
                        <option value="core/code">core/code</option>
                        <option value="core/column">core/column</option>
                        <option value="core/columns">core/columns</option>
                        <option value="core/cover">core/cover</option>
                        <option value="core/gallery">core/gallery</option>
                        <option value="core/group">core/group</option>
                        <option value="core/heading">core/heading</option>
                        <option value="core/image">core/image</option>
                        <option value="core/list">core/list</option>
                        <option value="core/list-item">core/list-item</option>
                        <option value="core/media-text">core/media-text</option>
                        <option value="core/paragraph">core/paragraph</option>
                        <option value="core/preformatted">core/preformatted</option>
                        <option value="core/pullquote">core/pullquote</option>
                        <option value="core/quote">core/quote</option>
                        <option value="core/separator">core/separator</option>
                        <option value="core/spacer">core/spacer</option>
                        <option value="core/table">core/table</option>
                        <option value="core/verse">core/verse</option>
